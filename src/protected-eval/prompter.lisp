...
;;
(kr:create-instance 'PROMPTER-GADGET GG:Query-Gadget
  #-garnet-v2.1 :declare
  #-garnet-v2.1 ((:parameters :string :field-width :input-font :value
...
(defun prompter-gadget-go ()
  (let (agg egadget qgadget feed)
    ...
    (opal:add-component agg
			(create-instance nil text-button-panel
			  (:final-feedback-p NIL)
			  (:left 10)(:top 10)
